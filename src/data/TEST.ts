export const TESTS = [
    ...
    // personalColorEng
    {
      ...
      questions: [
        {
          which: "EI",
          question: "When meeting new friends, I am?",
          answers: [
            {
              type: "E",
              content: "I start the conversation first.",
            },
            {
              type: "I",
              content: "Most of the time, other friends start the conversation first.",
            },
          ],
        },
        {
          which: "EI",
          question: "On weekends, I am?",
          answers: [
            {
              type: "E",
            ...
            {
              type: "I",
              content: "I don't mind being alone.",
            },
          ],
        },
        {
          which: "EI",
          question: "When playing with friends, I am?",
          answers: [
            {
              type: "E",
              content: "I enjoy a lively and fun atmosphere.",
            },
            {
              type: "I",
              content: "I enjoy a small conversation with a few friends.",
            },
          ],
        },
        {
          which: "SN",
          question: "What do I think is more important?",
          answers: [
            {
              type: "S",
            ...
            {
              type: "N",
              content: "Without thinking about the future, there is no development.",
            },
          ],
        },
        {
          which: "SN",
          question: "When working, I am?",
          answers: [
            {
              type: "S",
              content: "I like to follow what others are doing.",
            },
            {
              type: "N",
              content: "I like to create my own way.",
            },
          ],
        },
        {
          which: "SN",
          question: "What do people around me say about me?",
          answers: [
            {
              type: "S",
              content: "They often say I am persistent and patient.",
            },
            {
              type: "N",
              content: "They often say I am creative and original.",
            },
          ],
        },
        {
          which: "TF",
          question: "When I have to refuse, I am?",
          answers: [
            {
              type: "T",
              content: "I say I can't do it forcefully.",
            },
            {
              type: "F",
              content: "I think about it and mostly agree.",
            },
          ],
        },
        {
          which: "TF",
          question: "When I get angry, I am?",
          answers: [
            {
              type: "T",
              content: "I logically explain and argue.",
            },
            {
              type: "F",
              content: "I have a lot to say, but I get too upset and cry first.",
            },
          ],
        },
        {
          which: "TF",
          question:
            "When a friend talks about their worries, I am?",
          answers: [
            {
              type: "T",
              content: "I tell my friend about their wrong points.",
            },
            {
              type: "F",
              content: "I tell my friend about their wrong points.",
        ...
        {
          which: "JP",
          question: "When preparing for something, I am?",
          answers: [
            {
              type: "J",
              content: "I prepare a day before.",
            },
            {
              type: "P",
              content: "I often forget and put it off.",
            },
          ],
        },
        {
          which: "JP",
          question:
            "When I was about to go home and study, my friends grabbed me and said, ‘Let’s play!’ What do I do?",
          answers: [
            {
              type: "J",
              content: "I was caught off guard by something unexpected in my plans.",
            },
            {
              type: "P",
                content: "Okay! I'm glad I didn't follow my plans! Let's play!!!!",
            },
          ],
        },
        {
          which: "JP",
          question: "What is my style of the place I want to go?",
          answers: [
            {
              type: "J",
              content:
                  "I like to proceed with my plans! I like to be organized and follow the order of things.",
            },
            {
              type: "P",
              content:
                "I like to be flexible and go with the flow.",
            },
          ],
        },
      ],
